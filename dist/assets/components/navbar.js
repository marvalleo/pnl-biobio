class PnlNavbar extends HTMLElement {
    ...
    renderPublicNav(currentPath) {
        ...
        links.forEach(link => {
            ...
            navLinksHTML += `<a href="${link.path}" class="cursor-pointer font-extrabold uppercase text-[11px] tracking-[0.12em] transition-all duration-300 ${isActive} whitespace-nowrap">${link.label}</a>`;
        });
